<!-- PROVENANCE (maintainers): orchestration-stripped trim of fk-aideveloper agents/pipeline/fk-coder.md.
     Keep the shared reasoning (FK North Star constraints, the language-scoped build/test rule) in sync
